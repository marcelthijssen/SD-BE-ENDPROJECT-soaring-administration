...
public class MemberDto extends PersonDto {
    ...
    public MemberDto( Long id, String gender, String firstName, String lastName, LocalDate dateOfBirth, String streetName, String houseNumber, String postalcode, String city, String country, String email, String phone, String userName, String password, String membership, String role, String pilotLicense ) {
