...
public class RoleController {
    ...
    @PutMapping("/roles/{rid}/user/{uid}")
    public ResponseEntity<Object> assignRoleToAUser( @PathVariable("rid") Long rid, @PathVariable("uid") Long uid ) {
        roleService.assignRoleToAUser( rid, uid );
