...
INSERT INTO users (username, password, email, enabled) VALUES ( 'iemand', '$2a$10$wPHxwfsfTnOJAdgYcerBt.utdAvC24B/DWfuXfzKBSDHO0etB1ica', 'test@test.nl', TRUE);
...
INSERT INTO persons (id, gender, first_name, last_name, phone, date_of_birth, street_name, house_number, postalcode, city, country, email, pilot_license, membership_id)
VALUES (3001, 'm', 'Jeffrey', 'Johnson', '0612306345', '1994-08-19', 'straat', '3', '4817SX', 'Amsterdam', 'Nederland', 'sdbe@novi.nl', null, 4001);
INSERT INTO persons (id, gender, first_name, last_name, phone, date_of_birth, street_name, house_number,postalcode, city, country, email, pilot_license, membership_id)
...
VALUES (6001, true, '', '2022-04-14 10:00:37.185743', '120', '2022-04-14 15:03:07.185743', 5001, 1001, null, 2001, 3001, 3002, 3001);
INSERT INTO flights (id, instruction_flight, remarks, time_end, time_flown, time_start, plane_id, airport_start_id,
                     airport_end_id, starting_methode_id, passenger_id, captain_id, billed_person_id)
VALUES (6002, false, '', '2022-04-14 10:00:37.185743', '6', '2022-04-14 15:03:07.185743', 5002, 1001, null, 2001, 3001, 3003, 3003);